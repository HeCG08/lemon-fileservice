...
/**
* Global variables
* @author Happy Fish / YuQing /lonyee
...
public class ClientGlobal
{
	...
	*/
	...
	public static void init(FDFSConfig fdfsConfig) {
		...
		g_tracker_group = new TrackerGroup(tracker_servers);
		g_tracker_http_port = fdfsConfig.getHttpTrackerPort();
		g_anti_steal_token = fdfsConfig.getHttpAntiStealToken();
		if (g_anti_steal_token)	{
			g_secret_key = fdfsConfig.getHttpSecretKey();
		}
	}
